# Academia Cosmo Music - Plantilla base para administración
...
Cosmo Music proporciona una plantilla de administración ligera y modular pensada para gestionar la academia. El diseño y la API de layout permiten personalizar el proyecto para múltiples dispositivos — móvil y escritorio — manteniendo una experiencia consistente.

## Table of Contents

* [Versions](#versions)
* [Cosmo Music PRO](#coreui-pro)
* [Plantillas Pro de Cosmo Music](#coreui-pro-react-admin-templates)
...
* [Creators](#creators)
* [Community](#community)
* [Support Cosmo Music Development](#support-coreui-development)
